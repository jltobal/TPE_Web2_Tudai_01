                        ...
                        {foreach from=$impresora item=$info} 
                            <form method="POST" action='editar_impresora'>  
                                <tr>                            
                                    ...
                                    <td><input type="text" name="marca" value={$info->marca}></td>
                                    <td><input type="text" name="modelo" value={$info->modelo}></td>
                                    <td><input type="text" name="descripcion" value="{$info->descripcion}"></td>"
                                    ...
                                    <td><a href="eliminar_impresora/{$info->id_metodo}">Eliminar</a></td>
                                    <td> <button type="submit">EDITAR</button> </td>                             
                                </tr>
                            </form>
                        {/foreach}
